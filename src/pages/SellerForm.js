...
import "../styles/SellerForm.css"; // Import CSS for styling
...
const SellerForm = () => {
  ...
  const handleFileChange = (e, setter) => {
    setter([...e.target.files]); // Store multiple files
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert(`Property submitted successfully! Property ID: ${response.data.property._id}`);
      ...
      if (err.response && err.response.status === 400) {
        setError("Bad Request: Please check your input fields and try again.");
  ...
  return (
    <div className="form-container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <label>Upload Documents (Multiple PDFs, DOCX):</label>
